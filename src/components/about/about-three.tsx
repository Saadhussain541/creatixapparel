        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-6 col-lg-6 col-md-8">
            <div className="tp-about-3-content">
              ...
              We create high-quality embroidery digitizing and clean, scalable vector files for apparel and
              branding. Along with this.
              </p>
              <p className="mb-45 tp_fade_bottom">
              we produce all types of custom patches including embroidery,
chenille, woven, PVC, leather, and sublimation—crafted with precision and premium finishing.
              </p>
